			...
			<MainLayout>
				<Section>
					<div className="w-full md:mx-2 md:w-9/12">
						...
						<p className="mb-2">
							I learned software development on my own from online
							courses, YouTube, and documents including books,
							blogs, and software documentations.
						</p>
						<p className="mb-2">
							I'd done Diploma of Associate Engineering (DAE) in
							Electronics from GCT Sialkot, Pakistan. While I was
							in college, I learned about programming
				...
				<Section>
					<div className="w-full md:mx-2 md:w-1/3">
						...
						<p className="mb-2">
							...
							including <u>Java</u>, <u>C#</u>, and <u>C</u> but
							I'm profound and professionally experienced in the
							listed ones.
						</p>
					</div>
